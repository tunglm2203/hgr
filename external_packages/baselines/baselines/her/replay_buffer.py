...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    #
    # def sample_old(self, batch_size, beta=0.):
    #     """
    #     Returns:
    ...
    #     if max(idxes) >= self.get_current_size():
    #         print('[AIM_ERROR]: The maximum of index is out of range: {}'.format(max(idxes)))
    ...
    #
    # def _sample_proportional_old(self, batch_size):
    #     res = []
    #     p_total = self._it_sum.sum(0, self.get_current_size() - 1)  # -1 to prevent out of range
    ...
    #     return res
    #
    # def _encode_sample_old(self, episode_batch, idxes):
    ...
    #     return transitions, [episode_idxs, t_samples]
    #
    # def update_priorities_old(self, idxes, priorities):
    ...
    def sample(self, batch_size, beta=0.):
        ...
        transitions, extra_info = self._encode_sample(buffers, episode_idxs)
    ...
    def _encode_sample(self, episode_batch, episode_idxs):
