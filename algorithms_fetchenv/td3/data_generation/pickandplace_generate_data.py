...
def main():
    ...
    while len(actions) < numItr:
        ...
        ob, ac, rew, ret, info, time_step, done = goToGoal(env, obs, use_with_ddpg_her)
    ...
    np.savez_compressed(fileName, ep_rets=ep_returns, obs=observations, rews=rewards,
                        acs=actions, info=infos, done=dones)
